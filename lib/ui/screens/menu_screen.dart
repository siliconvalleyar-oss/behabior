                        ...
                        child: Column(
                          children: [
                            _MenuButton(
                              ...
                              gradient: AppTheme.primaryGradient,
                              onTap: () => state.navigateTo(AppScreen.levelSelect),
                            ),
                            ...
                            _MenuButton(
                              ...
                              onTap: () => state.navigateTo(AppScreen.achievements),
                            ),
                            const SizedBox(height: 12),
                            _MenuButton(
                              label: 'SKILLS',
                              ...
                              onTap: () => state.navigateTo(AppScreen.shop),
                            ),
                            const SizedBox(height: 12),
                            _MenuButton(
                              label: 'SETTINGS',
                              ...
                              onTap: () => state.navigateTo(AppScreen.settings),
                            ),
                          ],
                        ),
                      ),
